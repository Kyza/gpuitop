...
use gpuitop_ui::app::app_view;
use gpuitop_ui::assets::{layered, lucide};
use gpuitop_ui::properties_window::PropertiesWindow;
use gpuitop_ui::themes;
	...
	app.run(move |cx: &mut App| {
		...
		cx.open_window(
			...
			|window, cx| {
				...
				themes::apply_theme_by_name(&theme_name, Some(window), cx);
				cx.new(|cx| Root::new(view, window, cx))
			},
		)
